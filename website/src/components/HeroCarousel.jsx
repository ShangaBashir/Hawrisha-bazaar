...
export default function HeroCarousel({ onShopNow }) {
  ...
  return (
    <div className="relative w-full min-h-[50vh] sm:min-h-[60vh] bg-[#F5F5DC] flex flex-col items-center justify-center pt-8 sm:pt-12 pb-6 sm:pb-8 overflow-hidden">
      ...
      <motion.h1 
        ...
        className="text-xl sm:text-3xl md:text-4xl font-bold text-[#36454F] text-center max-w-2xl px-6 z-10 tracking-tight"
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="px-5 py-2 bg-[#36454F] hover:bg-[#B2AC88] text-white rounded-full font-medium transition-all duration-300 shadow-lg z-10 text-xs cursor-pointer"
      >
