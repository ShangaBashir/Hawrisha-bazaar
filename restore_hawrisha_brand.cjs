...
const faviconHContent = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="1 2 19 20" fill="none">
  <path d="M 4 2 h 5 v 20 H 3 a 2 2 0 0 1 -2 -2 a 2 2 0 0 1 2 -2 h 1 V 2 Z M 15 2 h 5 v 20 H 14 a 2 2 0 0 1 -2 -2 a 2 2 0 0 1 2 -2 h 1 V 2 Z M 9 10 h 6 v 3 H 9 Z" fill="#36454F" />
</svg>`;
...
faviconPaths.forEach(fp => {
  if (fs.existsSync(fp)) {
    fs.writeFileSync(fp, faviconHContent, 'utf8');
    console.log(`Restored favicon H logo: ${fp}`);
  }
});
...
console.log('Restoring Hawrisha brand name & H logo...');
targetDirs.forEach(dir => processDirectory(dir));
targetFiles.forEach(file => processFile(file));
console.log('Finished restoring Hawrisha brand!');
