...
export default function ShowcaseSection({ onViewAll }) {
  ...
  return (
    <section className="w-full bg-[#F5F5DC] py-12 md:py-20 px-4 sm:px-6 md:px-12 lg:px-24 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-16">
        ...
        >
          ...
          <motion.div variants={textLineVariants} className="flex flex-wrap items-center gap-4">
            <button
              onClick={onViewAll}
              className="px-6 md:px-8 py-3 md:py-3.5 bg-[#36454F] text-white rounded-full font-medium hover:bg-[#B2AC88] transition-colors duration-300 text-sm cursor-pointer shadow-lg shadow-black/10 hover:scale-105 active:scale-95"
            >
